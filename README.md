...
Floating-base task IK is demonstrated in `usage/robot_inverse_kinematics_analysis.ipynb`, which solves a weighted least-squares IK step over base twist and joint rates and integrates it with `mapaccum`.
...
- [x] Inverse kinematics (closed form + floating-base task IK in notebook)
